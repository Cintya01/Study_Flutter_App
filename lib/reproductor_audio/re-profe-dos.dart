...
class AudioProfe extends StatefulWidget {
  const AudioProfe({super.key});

  @override
  State<AudioProfe> createState() => _AudioProfeState();
}

class _AudioProfeState extends State<AudioProfe> {
  ...
  Widget build(BuildContext context) {
    ...
    double controlsPosition = size.height * .2;
